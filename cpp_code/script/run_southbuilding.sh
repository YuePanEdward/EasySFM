#data path
image_folder=/media/edward/BackupPlus/Data/sfm_data/south-building/test_img;
image_list=/media/edward/BackupPlus/Data/sfm_data/south-building/sub_image_list.txt;
calib_k_file=/media/edward/BackupPlus/Data/sfm_data/south-building/Calibration/K.txt;
calib_distort_file=/media/edward/BackupPlus/Data/sfm_data/south-building/Calibration/distort.txt; # not neccessary, if not provided, just set it as none
output_file=../test_data/output/sfm_sparse_point_cloud_southbuilding.ply;

#processing parameters
feature_type=S;                 # S for SURF an O for ORB
feature_parameter=500;          # For SURF, this is the minHessian, for ORB, this is the max number of features [int]
